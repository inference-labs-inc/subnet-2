...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 6, 33, 4, "", "inference.proto"
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_INFERENCEREQUEST"].fields_by_name["data"]._loaded_options = None
    _globals["_INFERENCEREQUEST"].fields_by_name[
        "data"
    ]._serialized_options = b"\020\001"
    _globals["_INFERENCEREQUEST"].fields_by_name["shape"]._loaded_options = None
    _globals["_INFERENCEREQUEST"].fields_by_name[
        "shape"
    ]._serialized_options = b"\020\001"
