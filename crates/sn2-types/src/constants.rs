...
pub const PERFORMANCE_CURVE_POWER: f64 = 5.0;
...
pub const PERFORMANCE_SCORING_PERCENTILE: f64 = 0.25;
pub const PERFORMANCE_RATE_CAP: f64 = 2.0;
pub const CAPACITY_WINDOW_SIZE: usize = 50;
...
pub const CAPACITY_RAMP_REL_SPEED: f64 = 1.0;
pub const CAPACITY_BACKOFF_REL_SPEED: f64 = 0.85;
pub const CAPACITY_UNIT_REFERENCE_PERCENTILE: f64 = 0.5;
