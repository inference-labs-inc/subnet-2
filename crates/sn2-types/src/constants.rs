...
pub const CAPACITY_SATURATION_TOLERANCE: f64 = 1.5;
pub const CAPACITY_SATURATION_RAMP_CEILING: f64 = 1.25;
pub const CAPACITY_SATURATION_LATENCY_FLOOR_SECS: f64 = 0.5;
