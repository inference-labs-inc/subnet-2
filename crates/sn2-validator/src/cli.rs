...
pub struct Cli {
    ...
    #[arg(long, default_value_t = false, help = "Run without chain interaction for local integration testing")]
    pub loopback: bool,

    #[arg(long, default_value = "127.0.0.1:8091", help = "Miner address (ip:port) for loopback mode")]
